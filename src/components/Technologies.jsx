...
const Technologies = () => {
  ...
  const techStack = [
    ...
    { name: "Jest", iconref: <SiJest className={gridStyle} /> },
    { name: "Cypress", iconref: <SiCypress className={gridStyle} /> },
    ...
    { name: "MySQL", iconref: <SiMysql className={gridStyle} /> },
    { name: "MongoDB", iconref: <SiMongodb className={gridStyle} /> },
    { name: "Mongoose", iconref: <SiMongoose className={gridStyle} /> },
